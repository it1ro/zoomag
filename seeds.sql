...
DBCC
CHECKIDENT('Unit', RESEED, 0);
SET
IDENTITY_INSERT Unit ON;
...
VALUES (1, N'шт'),
       ...
       (5, N'м');
SET
IDENTITY_INSERT Unit OFF;

DBCC
CHECKIDENT('Category', RESEED, 0);
SET
...
DBCC
CHECKIDENT('Product', RESEED, 0);
SET
IDENTITY_INSERT Product ON;
INSERT INTO Product (Id, Name, UnitId, CategoryId, Price, Amount)
VALUES (1, N'Корм для кошек Whiskas', 1, 1, 150, 50),
...
DBCC
CHECKIDENT('Supply', RESEED, 0);
SET
IDENTITY_INSERT Supply ON;
INSERT INTO Supply (Id, Name, Date)
VALUES (1, N'Поставка кормов от 01.11.2025', '2025-11-01'),
...
SET
IDENTITY_INSERT Supply OFF;

DBCC
CHECKIDENT('Sale', RESEED, 0);
SET
IDENTITY_INSERT Sale ON;
INSERT INTO Sale (Id, Name, Date, Amount, Price)
VALUES (1, N'Продажа от 06.11.2025 10:00', '2025-11-06 10:00:00', 3, 650),
...
SET
IDENTITY_INSERT Sale OFF;

-- Теперь вставляем элементы поставок и продаж, используя правильные ID
INSERT INTO SupplyProducts (SupplyId, ProductId, Quantity, Price, Total)
VALUES (1, 1, 100, 140, 14000),
       (1, 2, 50, 190, 9500),
       (1, 3, 60, 170, 10200),
       (2, 4, 200, 240, 48000),
       (2, 5, 30, 290, 8700),
...
INSERT INTO SalesProducts (SaleId, ProductId)
VALUES (1, 1),
       (1, 4),
       (1, 15),
       (2, 2),
