...
public partial class IncomingGoodsJournalWindow : Window
{
    ...
    private void ExportToExcel(object sender, RoutedEventArgs e)
    {
        ...
        var saveFileDialog = new SaveFileDialog
        {
            ...
            InitialDirectory =
                Environment.GetFolderPath(Environment.SpecialFolder.Desktop) // Начальная папка - рабочий стол
        };
        ...
        var fileName = saveFileDialog.FileName; // Получаем выбранный путь к файлу
